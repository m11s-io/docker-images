...
| [m11s/comfy-mcp](https://hub.docker.com/r/m11s/comfy-mcp) | Comfy MCP stdio server with the Comfy CLI engine; targets a separately deployed ComfyUI | ![Version](https://img.shields.io/docker/v/m11s/comfy-mcp?label=) |
